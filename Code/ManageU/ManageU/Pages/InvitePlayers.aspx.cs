    ...
    public partial class InvitePlayers : System.Web.UI.Page
    {
        ...
        protected void changeEmails(object sender, EventArgs e)
        {
            ...
            while(numEmails > 0)
            {
                ...
                TextBox emailsBox = new TextBox();
                emailsBox.ID = "email" + idCount.ToString();
                emailsBox.Attributes["runat"] = "server";
                emailsBox.Attributes["placeholder"] = "Email Address " + idCount.ToString();
                emailsBox.Attributes["style"] = "display: block; margin: 0 auto;width:250px;max-width:250px;";
                emailsBox.CssClass = "form-control";
                
                emailsDiv.Controls.Add(emailsBox);
                emailsDiv.Controls.Add(new LiteralControl("<br/>"));
